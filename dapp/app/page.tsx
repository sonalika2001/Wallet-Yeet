    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 grid lg:grid-cols-[1.2fr,1fr] gap-12 items-center relative">
          <div>
            <span className="pill pill--lilac mb-4">
              ETHGlobal Open Agents · Sepolia
            </span>
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05]">
              Yeet that wallet.
              <br />
              <span className="text-gradient">Don&apos;t bail — yeet.</span>
            </h1>
            <p className="mt-5 text-lg text-ink-700 max-w-xl">
              Three specialized AI agents discover, audit, and plan your wallet
              migration. You choose what goes where. One signature does it all
              — multi-destination routing, dust auto-conversion, ENS subnames
              and approvals, all wrapped up.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-ink-500">
              ...
              <span>Built solo for hackathon</span>
            </div>
          </div>
            ...
            <div className="card-pop p-6 bg-gradient-to-br from-peach-50 via-white to-lilac-50">
              ...
              <div className="flex flex-col items-center gap-3 py-6">
                ...
                <div className="text-xs text-ink-500 -mt-1">
                  multi-asset · multi-destination · one sig
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="card-pop p-6 bg-mint-50/60">
            ...
            <ul className="mt-4 space-y-2 text-sm text-ink-700">
              ...
              <li>✅ Dust auto-swapped to USDC via Uniswap</li>
              <li>✅ Atomic-style execution via KeeperHub MCP</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-10">
          ...
          <h2 className="font-display text-4xl font-bold mt-2">
            Three agents. One yeet.
          </h2>
          <p className="text-ink-500 mt-2 max-w-xl mx-auto">
            Each Claude Haiku agent has a focused job. They run sequentially —
            ~3s each, ~9s total — and stream progress to the UI.
          </p>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-20">
        <div className="card-pop p-8 sm:p-10 bg-gradient-to-br from-peach-50 via-white to-lilac-50 text-center">
          ...
          <p className="text-ink-500 mt-2">
            Connect your old wallet. We&apos;ll do the rest.
          </p>
